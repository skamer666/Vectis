...
// memoire ne survit pas a une eviction d'isolate Worker, et n'est pas
// partage entre les isolates qui traitent des requetes en parallele -- un
// attaquant determine passerait au travers en quelques requetes. La
// fonction Postgres est atomique et partagee par construction (fonctionne
// identiquement sur api/*.js Vercel et functions/api/*.js Cloudflare).
//
...
//
// process.env.X fonctionne tel quel grace au flag nodejs_compat (voir
...
export async function checkRateLimit(req, endpoint, maxRequests, windowSeconds) {
